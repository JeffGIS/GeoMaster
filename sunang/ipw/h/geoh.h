...
extern bool_t    EXFUN(geohcheck, (GEOH_T **geohpp, int nbands));
extern GEOH_T ** EXFUN(geohdup, (GEOH_T **oldhpp, int nbands));
extern int       EXFUN(geohfree, (GEOH_T **geohpp, int nbands));
extern GEOH_T  * EXFUN(geohmake, (double bline, double bsamp, double dline,
                         double dsamp, char *units, char *csys));
extern GEOH_T ** EXFUN(geohread, (int fd));
extern double    EXFUN(geohspace, (GEOH_T *geoh));
extern int       EXFUN(geohwrite, (int fd, GEOH_T **geohpp));

/* $Header: geoh.h,v 1.7 88/03/06 06:47:43 dozier Exp $ */
#endif
