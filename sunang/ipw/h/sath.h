...
extern bool_t     EXFUN(sathcheck, (SATH_T **sathpp, int nbands));
extern SATH_T  ** EXFUN(sathdup, (SATH_T **oldhpp, int nbands));
extern SATH_T   * EXFUN(sathmake, (char *platform, char *sensor, char *location,
                          char *gmdate, char *gmtime));
extern SATH_T  ** EXFUN(sathread, (int fd));
extern int        EXFUN(sathwrite, (int fd, SATH_T **sathpp));

/* $Header: sath.h,v 1.1 88/07/27 17:43:57 judy Exp $ */
#endif
