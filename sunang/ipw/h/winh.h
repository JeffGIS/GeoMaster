...
extern bool_t    EXFUN(winhcheck, (WINH_T **winhpp, int nbands));
extern WINH_T ** EXFUN(winhdup, (WINH_T **oldhpp, int nbands));
extern WINH_T  * EXFUN(winhmake, (double bline, double bsamp, double dline,
                         double dsamp));
extern WINH_T ** EXFUN(winhread, (int fd));
extern int       EXFUN(winhwrite, (int fd, WINH_T **winhpp));
extern int       EXFUN(winhfree, (WINH_T **winhpp, int nbands));

/* $Header: winh.h,v 1.7 88/02/13 16:53:57 frew Exp $ */
#endif
