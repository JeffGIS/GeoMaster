...
/*
** NAME
**	betanaught -- compute beta_0 for Henyey-Greenstein function
**
** SYNOPSIS
**	double betanaught(mu0, g)
**	double mu0, g;
**
** DESCRIPTION
**	Betanaught computes the value of beta_0 for a Henyey-Greenstein
...
**
** ERRORS
**	Dies if irrecoverable error.
**
** WARNINGS
**	Warns if Legendre polynomial doesn't converge.  Values printed
**	allow user to determine if this is a problem.
**
** APPLICATION USAGE
**
** FUTURE DIRECTIONS
...
#ifndef	lint
static char     rcsid[] = "$Header: /usr.MC68020/home/dozier/src/src.lib/libD/RCS/betanaught.c,v 1.3 89/07/05 15:49:11 dozier Exp $";
