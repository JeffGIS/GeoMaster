	...
	fpixel_t       *mu0;		/* cosine solar zenith angle	 */
{
 ...
 /* NOSTRICT */
		o_sunh = (SUNH_T **)
			hdralloc(1, sizeof(SUNH_T *), fdo, SUNH_HNAME);
		assert(o_sunh != NULL);
...
#ifndef	lint
static char     rcsid[] = "$Header: /usr/home/dozier/ipw/src/bin/toporad/RCS/head_init.c,v 1.1 89/07/05 13:25:23 dozier Exp $";
