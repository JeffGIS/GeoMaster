...
extern PROF_HDR *profhdr();
extern char    *proj();
extern char    *units();
extern double   bigatof();
extern double   litatof();
extern int      atoid();
extern void     demhdr();
extern void     headers();
extern void     output();
extern void     prdemhdr();
extern void     prprofhdr();
extern void	profiles();
extern void     fillvec();

/* $Header: pgm.h,v 1.2 89/01/08 09:32:20 dozier Exp $ */
#endif
