...
profiles()
{
  ...
  */
	parm.ftemp = tempnam(NULL, "dem");
	assert(parm.ftemp != NULL);
	fdt = uwopen(parm.ftemp);
	assert(fdt != ERROR);
	parm.maxelevs = 0;
...
#ifndef	lint
static char     rcsid[] = "$Header: /home/ipw/src/bin/dempt/RCS/profiles.c,v 1.4 89/11/17 14:22:18 frew Exp $";
