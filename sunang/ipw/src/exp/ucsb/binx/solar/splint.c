...
**
**  SYNOPSIS
**	double	splint(x, y, nx, c, a, b)
**	double	*x, *y, *c, a, b;
**	int	nx;
**
**  DESCRIPTION
**	returns integral of spline function
**
**	x =	vector of abscissas
**	y =	vector of ordinates
**	nx=	length of x & y vectors
**	cx=	vector of splines of length 3*nx
**	a,b	interval of integration
**
**  DIAGNOSTICS
**	Sets errno to ERROR and writes message via usrerr
**
**  bugs
*/
