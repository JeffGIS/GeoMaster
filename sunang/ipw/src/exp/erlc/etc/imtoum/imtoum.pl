...
# page (nroff -man format).  It was intended to be a 90% solution to get
# something to then edit, but it turns out that for almost all the manual
# pages, it gives exactly what I want.
#
# This program started out as a quick and dirty solution, and turned out to
# work.  I'm sorry for the state of the code -- it is certainly not a good
# example of Perl, or good programming practices.  It is not robust at all,
# and hangs if it does not get a correct IPW manual page.  Of course, that
# tells you that the manual page is not formatted correctly.
#
# Written by Dana Jacobsen, ERL-C, July 1993.
#
