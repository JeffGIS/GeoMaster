...
ipwgetopt(argc, argv, optstring)
	...
	CONST char     *optstring;	/* legal option letters		 */
{
 /*
...
#ifndef	lint
static char     rcsid[] = "$Header: /tmp7/jimbo/ipw.v1.0/src/lib/libipw/args/RCS/ipwgetopt.c,v 1.1 93/02/02 08:30:15 jimbo Exp $";
