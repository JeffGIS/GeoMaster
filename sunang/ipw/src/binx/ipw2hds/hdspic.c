...
hdspic()
{
  ...
  */
 /* NOSTRICT */
		(void) memset((char *) sixel, SIXEL_BIAS, (xsize_t) nsixels);
  ...
  */
 /* NOSTRICT */
		(void) fwrite((char *) sixel, (xsize_t) nsixels,
...
#ifndef	lint
static char     rcsid[] = "$Header: /home/ipw/src/bin/hdspic/RCS/hdspic.c,v 1.2 89/11/17 15:40:01 frew Exp $";
