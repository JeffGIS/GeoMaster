...
public:
    ...
    * @param record the record to write
    * @param stream the stream to write to
    * @param idx the index of the data item to write
    * @return status code indicating success or failure
    */
   static LT_STATUS writeRecordData(const LTIMetadataRecord& record,
                                    LTIOStreamInf& stream,
                                    int idx);
    ...
    */
   static LT_STATUS writeFormattedRecord(const LTIMetadataRecord& record,
                                         LTIOStreamInf& stream,
