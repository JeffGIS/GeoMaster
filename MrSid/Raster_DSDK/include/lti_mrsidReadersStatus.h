...
#define LTI_STS_MrSIDReaders_ColorSpace_NumBandsMismatch   50022
LT_STATUSSTRING_ADD(LTI_STS_MrSIDReaders_ColorSpace_NumBandsMismatch, "mismatch between colorspace and number of bands")
