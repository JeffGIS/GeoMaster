...
#define LTI_STS_Filters_UnsupHistogramVersion         50240
LT_STATUSSTRING_ADD(LTI_STS_Filters_UnsupHistogramVersion, "unsupported histogram version")

#define LTI_STS_Filters_NumberOfBandsMismatch         50241
LT_STATUSSTRING_ADD(LTI_STS_Filters_NumberOfBandsMismatch, "number of bands mismatch")

#define LTI_STS_Filters_HistogramOpenErr              50242
LT_STATUSSTRING_ADD(LTI_STS_Filters_HistogramOpenErr, "could not open histogram file")

#define LTI_STS_Filters_StreamReadError               50243
LT_STATUSSTRING_ADD(LTI_STS_Filters_StreamReadError, "error reading stream")

#define LTI_STS_Filters_StreamWriteError              50244
LT_STATUSSTRING_ADD(LTI_STS_Filters_StreamWriteError, "error writing stream")

#define LTI_STS_Filters_SourceNeedsAlpha              50245
LT_STATUSSTRING_ADD(LTI_STS_Filters_SourceNeedsAlpha, "missing required alpha band")
