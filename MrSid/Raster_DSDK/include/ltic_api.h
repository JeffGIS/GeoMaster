 ...
 *
 * The \a generation value returned will be 2 (for MrSID/MG2),
 * 3 (for MrSID/MG3), 4 (for MrSID/MG4) or 0 (if error).
 *
 * @param fileName   the file to get the version of
 * @param generation the MrSID generation
