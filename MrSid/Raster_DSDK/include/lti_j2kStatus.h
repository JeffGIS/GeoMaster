...
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_Base, "lt_lib_gmljp2 base")

#define LTI_STS_GMLJP2_ContainsNoGML                              51701
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_ContainsNoGML, "GMLJP2: The file contains no gml")

#define LTI_STS_GMLJP2_ContainsNoCoverage                         51702
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_ContainsNoCoverage, "GMLJP2: the file contains no coverages")

#define LTI_STS_GMLJP2_MalformedAssocBoxes                        51703
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_MalformedAssocBoxes, "GMLJP2: The Association Boxes are malformed")

#define LTI_STS_GMLJP2_CRSUnknown                                 51704
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_CRSUnknown, "GMLJP2: Coordinate Reference System is unknown")

#define LTI_STS_GMLJP2_HandledError                               51705
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_HandledError, "GMLJP2: we handled a gml4c exception")

#define LTI_STS_GMLJP2_BadSchemaPath                              51706
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_BadSchemaPath, "GMLJP2: The path to the Schema File is bad")

#define LTI_STS_GMLJP2_MalformedRootInstance                      51707
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_MalformedRootInstance, "GMLJP2: The gml.root-instance is malformed")

#define LTI_STS_GMLJP2_FailedCoverageCreation                      51708
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_FailedCoverageCreation, "Could not generate a gml coverage from geo information in the image")

#define LTI_STS_GMLJP2_CustomCRSNotSupported                       51709
LT_STATUSSTRING_ADD(LTI_STS_GMLJP2_CustomCRSNotSupported, "GMLJP2: Custom projections not supported")
