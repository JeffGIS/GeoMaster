...
#define LTI_STS_Metadata_ReadErorr                          50508
LT_STATUSSTRING_ADD(LTI_STS_Metadata_ReadErorr, "could not read metadata")

#define LTI_STS_Metadata_WriteErorr                         50509
LT_STATUSSTRING_ADD(LTI_STS_Metadata_WriteErorr, "could not write metadata")

#define LTI_STS_Metadata_CorruptFile                        50510
LT_STATUSSTRING_ADD(LTI_STS_Metadata_CorruptFile, "the metadata is corrupt")
