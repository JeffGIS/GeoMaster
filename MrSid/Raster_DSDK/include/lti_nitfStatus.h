...
#define LTI_STS_NITF_EncodingApplicationNotIdentified          51231
LT_STATUSSTRING_ADD(LTI_STS_NITF_EncodingApplicationNotIdentified, "The application did not identify itself")

#define LTI_STS_NITF_InvalidICORDS                             51232
LT_STATUSSTRING_ADD(LTI_STS_NITF_InvalidICORDS, "specified ICORDS value is invalid")

#define LTI_STS_NITF_UnsupGeocentricICORDS                     51233
LT_STATUSSTRING_ADD(LTI_STS_NITF_UnsupGeocentricICORDS, "writing geocentric IGEOLO is not supported (v2.0)")
