...
protected:
   void loadHeaderProps(LASHeaderHS *header);
   void loadClassNames(LASHeaderHS *header);
   static void loadMetadata(LASHeaderHS *header,
                            Metadata &metadata, bool sanitize);
