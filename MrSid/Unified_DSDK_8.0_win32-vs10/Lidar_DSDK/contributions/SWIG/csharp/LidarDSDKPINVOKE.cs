...
class LidarDSDKPINVOKE {
  ...
  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_CHANNEL_NAME_GPSTime_get")]
  public static extern string CHANNEL_NAME_GPSTime_get();
  ...
  public static extern void ChannelInfo_init__SWIG_0(HandleRef jarg1, string jarg2, int jarg3, int jarg4);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_ChannelInfo_init__SWIG_1")]
  public static extern void ChannelInfo_init__SWIG_1(HandleRef jarg1, HandleRef jarg2);
  ...
  public static extern void Object_retain(HandleRef jarg1);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_Object_release")]
  public static extern void Object_release(HandleRef jarg1);
  ...
  public static extern void ProgressDelegate_reportProgress(HandleRef jarg1, double jarg2);
  ...
  public static extern void ProgressDelegate_updateCompleted(HandleRef jarg1, double jarg2);
  ...
  public static extern void ProgressDelegate_director_connect(HandleRef jarg1, ProgressDelegate.SwigDelegateProgressDelegate_0 delegate0, ProgressDelegate.SwigDelegateProgressDelegate_1 delegate1);
  ...
  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_ChannelDataUpcast")]
  public static extern IntPtr ChannelDataUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_IOUpcast")]
  public static extern IntPtr IOUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_FileIOUpcast")]
  public static extern IntPtr FileIOUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_PointIteratorUpcast")]
  public static extern IntPtr PointIteratorUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_PointSourceUpcast")]
  public static extern IntPtr PointSourceUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_PointReaderUpcast")]
  public static extern IntPtr PointReaderUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_PointWriterUpcast")]
  public static extern IntPtr PointWriterUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_SimplePointWriterUpcast")]
  public static extern IntPtr SimplePointWriterUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_TXTPointReaderUpcast")]
  public static extern IntPtr TXTPointReaderUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_TXTPointWriterUpcast")]
  public static extern IntPtr TXTPointWriterUpcast(IntPtr objectRef);

  [DllImport("LizardTech.LidarDSDKp.dll", EntryPoint="CSharp_MG4PointReaderUpcast")]
  public static extern IntPtr MG4PointReaderUpcast(IntPtr objectRef);
}
