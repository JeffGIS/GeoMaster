...
void SwigDirector_ProgressDelegate::reportProgress(double progress) {
  ...
  if (!swig_callbackreportProgress) {
    ...
    jprogress = progress;
    swig_callbackreportProgress(jprogress);
  }
}
...
void SwigDirector_ProgressDelegate::swig_connect_director(SWIG_Callback0_t callbackreportProgress, SWIG_Callback1_t callbackgetCancelled) {
...
SWIGEXPORT char * SWIGSTDCALL CSharp_CHANNEL_NAME_GPSTime_get() {
  char * jresult ;
  char *result = 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_ChannelInfo_init__SWIG_0(void * jarg1, char * jarg2, int jarg3, int jarg4) {
  LizardTech::ChannelInfo *arg1 = (LizardTech::ChannelInfo *) 0 ;
  char *arg2 = (char *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_ChannelInfo_init__SWIG_1(void * jarg1, void * jarg2) {
  LizardTech::ChannelInfo *arg1 = (LizardTech::ChannelInfo *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_Object_retain(void * jarg1) {
...
SWIGEXPORT void SWIGSTDCALL CSharp_Object_release(void * jarg1) {
  LizardTech::Object *arg1 = (LizardTech::Object *) 0 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_ProgressDelegate_reportProgress(void * jarg1, double jarg2) {
  LizardTech::ProgressDelegate *arg1 = (LizardTech::ProgressDelegate *) 0 ;
  double arg2 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_ProgressDelegate_updateCompleted(void * jarg1, double jarg2) {
  LizardTech::ProgressDelegate *arg1 = (LizardTech::ProgressDelegate *) 0 ;
  double arg2 ;
...
SWIGEXPORT void SWIGSTDCALL CSharp_ProgressDelegate_director_connect(void *objarg, SwigDirector_ProgressDelegate::SWIG_Callback0_t callback0, SwigDirector_ProgressDelegate::SWIG_Callback1_t callback1) {
...
SWIGEXPORT LizardTech::ChannelInfo * SWIGSTDCALL CSharp_ChannelDataUpcast(LizardTech::ChannelData *objectRef) {
    return (LizardTech::ChannelInfo *)objectRef;
}

SWIGEXPORT LizardTech::Object * SWIGSTDCALL CSharp_IOUpcast(LizardTech::IO *objectRef) {
    return (LizardTech::Object *)objectRef;
}

SWIGEXPORT LizardTech::IO * SWIGSTDCALL CSharp_FileIOUpcast(LizardTech::FileIO *objectRef) {
    return (LizardTech::IO *)objectRef;
}

SWIGEXPORT LizardTech::Object * SWIGSTDCALL CSharp_PointIteratorUpcast(LizardTech::PointIterator *objectRef) {
    return (LizardTech::Object *)objectRef;
}

SWIGEXPORT LizardTech::Object * SWIGSTDCALL CSharp_PointSourceUpcast(LizardTech::PointSource *objectRef) {
    return (LizardTech::Object *)objectRef;
}

SWIGEXPORT LizardTech::PointSource * SWIGSTDCALL CSharp_PointReaderUpcast(LizardTech::PointReader *objectRef) {
    return (LizardTech::PointSource *)objectRef;
}

SWIGEXPORT LizardTech::Object * SWIGSTDCALL CSharp_PointWriterUpcast(LizardTech::PointWriter *objectRef) {
    return (LizardTech::Object *)objectRef;
}

SWIGEXPORT LizardTech::PointWriter * SWIGSTDCALL CSharp_SimplePointWriterUpcast(LizardTech::SimplePointWriter *objectRef) {
    return (LizardTech::PointWriter *)objectRef;
}

SWIGEXPORT LizardTech::PointReader * SWIGSTDCALL CSharp_TXTPointReaderUpcast(LizardTech::TXTPointReader *objectRef) {
    return (LizardTech::PointReader *)objectRef;
}

SWIGEXPORT LizardTech::SimplePointWriter * SWIGSTDCALL CSharp_TXTPointWriterUpcast(LizardTech::TXTPointWriter *objectRef) {
    return (LizardTech::SimplePointWriter *)objectRef;
}

SWIGEXPORT LizardTech::PointReader * SWIGSTDCALL CSharp_MG4PointReaderUpcast(LizardTech::MG4PointReader *objectRef) {
    return (LizardTech::PointReader *)objectRef;
}
