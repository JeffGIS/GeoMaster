...
/*@SWIG:C:\\swigwin-1.3.39\\Lib\\ruby\\rubyprimtypes.swg,23,%ruby_aux_method@*/
...
void SwigDirector_ProgressDelegate::reportProgress(double progress) {
  ...
  result = rb_funcall(swig_get_self(), rb_intern("reportProgress"), 1,obj0);
}
...
swig_class SwigClassDataTypeUtils;
...
swig_class SwigClassChannelInfo;
...
fail:
  Ruby_Format_OverloadedError( argc, 5, "ChannelInfo.init", 
...
fail:
  Ruby_Format_OverloadedError( argc, 3, "PointInfo.init", 
...
swig_class SwigClassChannelData;
...
_wrap_Metadata_getValue(int argc, VALUE *argv, VALUE self) {
  ...
  }
  {
    ...
    case LizardTech::METADATA_DATATYPE_STRING:
      vresult = HostObject_FromString(static_cast<const char *>(result));
      break;
    case LizardTech::METADATA_DATATYPE_BLOB:
      vresult = HostObject_FromBlob(result, length);
      break;
...
swig_class SwigClassProgressDelegate;
...
swig_class SwigClassPointIterator;
...
swig_class SwigClassPointSource;
...
swig_class SwigClassPointReader;
...
swig_class SwigClassPointWriter;
...
_wrap_PointWriter_getMetadata(int argc, VALUE *argv, VALUE self) {
  ...
  res1 = SWIG_ConvertPtr(self, &argp1,SWIGTYPE_p_LizardTech__PointWriter, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), Ruby_Format_TypeError( "", "LizardTech::PointWriter const *","getMetadata", 1, self )); 
  }
  arg1 = reinterpret_cast< LizardTech::PointWriter * >(argp1);
  {
    try
...
swig_class SwigClassSimplePointWriter;
...
swig_class SwigClassTXTPointReader;
...
swig_class SwigClassTXTPointWriter;
...
swig_class SwigClassMG4PointReader;
...
SWIGEXPORT void Init_LidarDSDK(void) {
  ...
  rb_define_const(mLidarDSDK, "CHANNEL_NAME_GPSTime", SWIG_FromCharPtr("GPSTime"));
