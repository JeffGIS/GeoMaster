...
public:
   ...
   LT_STATUS setSelectedBands(const lt_uint16 bandList[], lt_uint16 numBands);
   ...
   LT_STATUS createImageStage(lt_uint32 imageNumber,
                              const lt_uint16 bandList[],
                              lt_uint16 numBands,
                              MrSIDSingleImageReaderBase *&imageStage);
   LT_STATUS createOverviewImageStage(const lt_uint16 bandList[],
                                      lt_uint16 numBands,
                                      MrSIDSingleImageReaderBase *&imageStage);
