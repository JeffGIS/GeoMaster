...
SUPPORTED PLATFORMS:
    The supported platforms (for development) are:
        ...
        Windows 7 SP 1 Ultimate, Enterprise, Professional, Home Premium (32-bit and 64-bit)
        Windows 8.1 (with Update 2919355):  Enterprise, Professional  (32-bit and 64-bit)
        Windows 2012 R2 Server (with Update 2919355): Standard and Datacenter (64-bit)   
        Windows 10 version 1507 or higher: Professional and Enterprise (LTSB is not supported) (32-bit and 64-bit)  

        For more information, see https://www.visualstudio.com/en-us/productinfo/vs2017-system-requirements-vs
        See the same link for deployment options.

SOFTWARE REQUIREMENTS:
        Visual Studio 2017 (C++) Premium, Professional, Ultimate or Team Editions required for development.
...
of the API. A MS Visual Studio 2017 Solution and Projects are included for 
