...
DWORD DrawLineWithFlatEnd(HDC hDC, DWORD npt, HPPOINT pPoints, DWORD Width, COLORREF Color);
DWORD DrawLineWithFlatEndF(HDC hDC, DWORD npt, HPFPOINT pPoints, DWORD Width, COLORREF Color);
