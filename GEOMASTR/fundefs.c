...
int	GetFunctionID3 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "MSG", 3)) return 361;
			return 0;
}
int	GetFunctionID4 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "RGBI", 4)) return 444;
			return 0;
}
int	GetFunctionID5 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "VALUE", 5)) return 542;
...
int	GetFunctionID7 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "DOLLARS", 7)) return 793;
...
int	GetFunctionID8 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "PERSONAL", 8)) return 861;
			if (!_fstrnicmp(str, "URLTOMEM", 8)) return 862;
			return 0;
}
...
int	GetFunctionID14 (LPSTR str)
{
			...
			if (!_fstrnicmp(str, "DRIVEFREESPACE", 14)) return 1413;
