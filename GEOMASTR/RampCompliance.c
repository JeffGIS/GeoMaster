...
char *rampToText(int intNum, RampStruct *ramp, int codeSystem)
{
	...
	sprintf(rampText,
		"%i\t%i\t%i\t%s\t%i\t%s\t%s\t%i\t%s\t%i\t%i\t%c\t%s\t%s\t%s\t%s\t%s\t%.10f\t%.10f\t%i\t%s\t%s\t%s\t%s\t%c\t%c\t%c\t%c\t%c\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%i\t%i\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%i\t%i\t%s\t%s\t%i\t%i\t%s\t%i\t%i\t%i\t%i\t%.2f\t%.2f\t%s\t%s\t%i",
		ramp->uniqueID,
		intNum, altIntNum,
		intStreets,
		ramp->rampNum,
