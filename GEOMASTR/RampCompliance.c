...
char *rampToText(int intNum, RampStruct *ramp)
{
	...
	GetIntersectionStreetNames("", intNum, intStreets);
	sprintf(rampText, "%i\t%i\t%s\t%i\t'%s'\t'%s'\t%i\t'%s'\t%.10f\t%.10f\t%i\t'%s'\t'%s'\t'%s'\t'%s'\t%i\t%i\t%i\t%i\t%i\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%i\t%i\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%.2f\t%i\t%i\t'%s'\t'%s'\t%i\t%i\t'%s'\t%i\t%i\t%i\t%i\t%.2f\t%.2f\t'%s'\t'%s'\t%i\t%c",
		ramp->uniqueID,
		intNum,
		intStreets,
		ramp->rampNum,
