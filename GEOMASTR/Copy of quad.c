...
InDBlock:
        ...
        {   
            ...
            while (Offset >= 0)
            {
                ...
                CurRecLen = nBytes;
                hPltBuf = GSSiGlobAlloc ( 591,GMEM_MOVEABLE,(DWORD)nBytes);
...
GSSiExitProg (1221);
    ...
    _hread (FidMap,pQuadTree,LenQuad);
    if (hQuadTree2) 
    {
