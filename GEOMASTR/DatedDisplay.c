...
static  int			timeBetweenDates = TIME_MANUAL;
#define FADE_FULL	0
...
#define NBITMAPS	5
	...
	case WM_CLOSE:
		...
		case  WM_HSCROLL:
		timeBetweenDates = 2000 + 100 * SendDlgItemMessage(hWndDlg, IDC_SLIDER1, TBM_GETPOS, 0, 0);
		break;
	...
	case WM_COMMAND:
		...
		case IDC_PRIOR:
			...
			timerID = SetTimer(hWndDatedOrthos, GF_DISPLAY_DATED_ORTHOS, 1, 0);
			break;
		case IDC_NEXT:
